...
export type Session = { creativity:Creativity; generatedCreativity:Creativity; letterDetails:LetterDetails; uploadedPhotos:UploadedPhoto[]; analysis:Analysis|null; contextQuestions:MissingContextQuestion[]; contextAnswers:UserContextAnswer[]; storyType:StoryType; writingTone:WritingTone; generatedStory:GeneratedStory|null; isDemo:boolean; demoRevision:number; generatedStoryType:StoryType; generatedWritingTone:WritingTone; manuallyOrdered:boolean };
const initial:Session={creativity:0,generatedCreativity:0,letterDetails:emptyLetterDetails,uploadedPhotos:[],analysis:null,contextQuestions:[],contextAnswers:[],storyType:'essay',writingTone:'plain',generatedStory:null,isDemo:false,demoRevision:0,generatedStoryType:'essay',generatedWritingTone:'plain',manuallyOrdered:false};
