...
const initial:Session={fictionGenre:'literary',generatedFictionGenre:'literary',chapterCount:null,creativity:0,generatedCreativity:0,letterDetails:emptyLetterDetails,uploadedPhotos:[],analysis:null,contextQuestions:[],contextAnswers:[],storyType:'diary',writingTone:'plain',generatedStory:null,isDemo:false,demoRevision:0,generatedStoryType:'diary',generatedWritingTone:'plain',manuallyOrdered:false};
