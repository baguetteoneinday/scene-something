...
const initial:Session={fictionGenre:'literary',generatedFictionGenre:'literary',chapterCount:null,creativity:25,generatedCreativity:25,letterDetails:emptyLetterDetails,uploadedPhotos:[],analysis:null,contextQuestions:[],contextAnswers:[],storyType:'record',writingTone:'plain',generatedStory:null,isDemo:false,demoRevision:0,generatedStoryType:'record',generatedWritingTone:'plain',manuallyOrdered:false};
