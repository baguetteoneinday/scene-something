...
import { LETTER_STORY_SYSTEM_PROMPT,MEMORY_STORY_SYSTEM_PROMPT,FICTION_STORY_SYSTEM_PROMPT } from '@/lib/openai/prompts';
...
export async function POST(request:Request){try{
 ...
 const result=await structured('generated_story',storySchema,data.storyType==='fiction'?FICTION_STORY_SYSTEM_PROMPT:data.storyType==='letter'?LETTER_STORY_SYSTEM_PROMPT:MEMORY_STORY_SYSTEM_PROMPT,[{role:'user',content:JSON.stringify(input)}]);
